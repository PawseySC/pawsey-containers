...
# OpenFOAM-Org 12 source dependencies for Ubuntu 24.04 LTS
# Aggregated from:
...
WORKDIR $OFINSTDIR
#Use "git clone" as now recommended by https://openfoam.org/download/source/downloading-source-code/
RUN git clone https://github.com/OpenFOAM/OpenFOAM-${OFVERSION}.git \
