...
# Master Slurm test launcher for the lustre-mpich-base container image.
#
# The launcher:
...
# Run from anywhere:
#
#   ./setonix/mpi/lustre-mpich-base/testing/run_tests.sh
#
# Configuration values can be overridden for one invocation. Examples:
#
#   PARTITION=debug ./setonix/mpi/lustre-mpich-base/testing/run_tests.sh
#   RESERVATION=PAWSEY_XXX_TEST ./setonix/mpi/lustre-mpich-base/testing/run_tests.sh
#   EXECUTION_MODE=concurrent ./setonix/mpi/lustre-mpich-base/testing/run_tests.sh
#   SINGULARITY_IMAGE=/path/to/image.sif ./setonix/mpi/lustre-mpich-base/testing/run_tests.sh
#
...
REPO_LUSTRE_MPICH_BASE_DIR="$(cd "${TESTING_DIR}/.." && pwd)"
REPO_MPI_DIR="$(cd "${REPO_LUSTRE_MPICH_BASE_DIR}/.." && pwd)"
...
IMAGE_NAME="mpich-lustre-base"
IMAGE_TAG="mpich${MPICH_VERSION}-lustrerelease-ubuntu${OS_VERSION}"
...
echo "============================================================"
echo "lustre-mpich-base Slurm test launcher"
echo "============================================================"
