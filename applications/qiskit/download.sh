...
cd $script_dir
tar czvf downloaded_files.tar.gz lustre-build mpich-build osu-benchmarks-build qiskit-aer-build
echo "All files have been packaged into downloaded_files.tar.gz"

# del them
rm -rf lustre-build mpich-build osu-benchmarks-build qiskit-aer-build
